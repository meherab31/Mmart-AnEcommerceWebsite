...
<body data-bs-spy="scroll" data-bs-target="#bsb-tpl-navbar" data-bs-smooth-scroll="true" tabindex="0">
    ...
    <div class="container overflow-hidden">
      <div class="row gy-3 gy-lg-0 align-items-lg-center justify-content-lg-between">
        <div class="col-12 col-lg-6 order-1 order-lg-0">
          <h1 class="display-3 fw-bolder mb-3">We provide the best <br><mark class="bsb-tpl-highlight bsb-tpl-highlight-blue"><span class="bsb-tpl-font-hw display-2 text-accent fw-normal">quality product</span></mark> for every group of people</h1>
  ...
  <main id="main">
      ...
      <div class="container mb-5 mb-md-6 mb-xl-10">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h2 class="display-3 fw-bolder mb-4">You will get the <br>perfect <mark class="bsb-tpl-highlight bsb-tpl-highlight-yellow"><span class="bsb-tpl-font-hw display-1 text-accent fw-normal">attire</span></mark> with our proficient services.</h2>
          </div>
        </div>
      </div>
      ...
      <div class="container overflow-hidden">
        <div class="row gy-5 gx-md-4 gy-lg-0 gx-xxl-5 justify-content-center">
          <div class="col-11 col-sm-6 col-lg-3">
            ...
            <h4 class="mb-3">Fashion Consultation</h4>
            <p class="mb-3 text-secondary">Provide personalized fashion consultations to help customers find the perfect style for their body type, personality, and occasion. Offer advice on wardrobe essentials, styling tips, and current fashion trends. Conduct virtual or in-person consultations for individuals or groups.</p>
          </div>
          <div class="col-11 col-sm-6 col-lg-3">
            ...
            <h4 class="mb-3">Custom Tailoring</h4>
            <p class="mb-3 text-secondary">Offer custom tailoring services to create bespoke clothing pieces tailored to each customer's measurements and preferences. Provide a wide range of fabric options, style choices, and customization features to ensure a perfect fit and unique look. Work closely with customers to bring their design ideas to life and create one-of-a-kind garments.</p>
          </div>
          <div class="col-11 col-sm-6 col-lg-3">
            ...
            <h4 class="mb-3">Personal Shopping Services</h4>
            <p class="mb-3 text-secondary"> Provide personalized shopping experiences where customers receive one-on-one assistance from a fashion expert. Offer curated selections of clothing and accessories based on each customer's style preferences, budget, and occasion. Arrange private shopping appointments in-store or virtually, allowing customers to shop in a relaxed and comfortable environment.</p>
          </div>
          <div class="col-11 col-sm-6 col-lg-3">
            ...
            <h4 class="mb-3">Collaborations and Partnerships</h4>
            <p class="mb-3 text-secondary">Collaborate with fashion influencers, bloggers, and celebrities to promote your brand and reach a wider audience. Partner with other fashion brands, designers, or retailers for exclusive collaborations, limited-edition collections, or co-branded products. Sponsor fashion events, sponsorships, and charitable initiatives to enhance brand visibility and goodwill.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-9 col-lg-8 col-xl-8 col-xxl-7">
            <h3 class="fs-5 mb-3 text-white text-uppercase"><mark class="text-white bsb-tpl-highlight">Unlock New Styles</mark></h3>
            <h2 class="display-3 text-white fw-bolder mb-4 pe-xl-5">We design new trends and develop the product in own factory.</h2>
            <a href="{{url('products')}}" class="btn btn-accent bsb-btn-3xl rounded mb-0 text-nowrap">Buy Now</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="scrollspyproducts" class="py-5 py-xl-8 bsb-section-py-xxl-1">
      <div class="container mb-5 mb-md-6 mb-xl-10">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h2 class="display-3 fw-bolder mb-4">Check our products to <br><mark class="bsb-tpl-highlight bsb-tpl-highlight-yellow"><span class="bsb-tpl-font-hw display-1 text-accent fw-normal">kickstart</span></mark> a latest trend.</h2>
          </div>
        </div>
      </div>
        ...
        <div class="row gy-2 g-md-2 g-xl-3 bsb-project-2-grid">
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale-up bsb-hover-scale" src="./assets/img/products/w3.png" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInLeft">Women Woven</h3>
                <div class="text-white bsb-hover-fadeInRight">Women</div>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" src="./assets/img/products/menjacket.png" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInUp">Men Jacket</h3>
                <div class="text-white bsb-hover-fadeInDown">Men</div>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale-up bsb-hover-scale" src="./assets/img/products/w2.png" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInLeft">Women Jacket</h3>
                <div class="text-white bsb-hover-fadeInRight">Women</div>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" src="./assets/img/products/men2.png" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInUp">Men Woven</h3>
                <div class="text-white bsb-hover-fadeInDown">Women</div>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" src="./assets/img/products/w1.png" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInUp">Women Top</h3>
                <div class="text-white bsb-hover-fadeInDown">Women</div>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" src="./assets/img/products/menpolo.png" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInUp">Men Polo</h3>
                <div class="text-white bsb-hover-fadeInDown">Men</div>
              </figcaption>
            </figure>
          </div>
