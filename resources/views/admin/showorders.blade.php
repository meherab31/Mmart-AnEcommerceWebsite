                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <input type="text" id="searchInput" class="form-control text-white"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($order->delivery_status == 'processing')
                                                                <form action="{{ url('delivery', $order->id) }}"
                                                                    method="POST"
                                                                    onsubmit="return confirm('Delivered Successfully?')">
                                                                    @csrf
                                                                    <button type="submit"
                                                        ...
                                                        <td>
                                                            <a href="{{ url('reciept', $order->id) }}"
                                                                class="btn btn-info">Order Reciept</a>
                                                        </td>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <p class="text-center">Showing {{ $orders->firstItem() }} to
                                            {{ $orders->lastItem() }} of {{ $orders->total() }} results</p>
                                    </div>
                                </div>
